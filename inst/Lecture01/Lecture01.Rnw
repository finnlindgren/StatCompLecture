...
\begin{frame}
  ...
  Simon Taylor, Jinlu Liu, Dimitrios Doudesis
  \item Computer labs: w1--4 and w6--9, Wed 09:00--11:00 or 15:30--17:30\\
  Zoom
  \item Office Hours/Live Demonstrations: every week, Thursdays 13:00-14:00\\
  Zoom
...
\begin{frame}
\frametitle{RStudio recommendations}
\begin{itemize}
\item Use R version 3.6.1 or later. Available on lab computers. Free to download for laptops:\\
